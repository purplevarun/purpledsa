...
let order = 0;
function p(name: string, difficulty: "E" | "M" | "H", slug: string, hints: string[]) {
  order += 1;
  return { order, slug, name, difficulty, url: lc(slug), locked: false, hints };
}
...
export const topInterview: ProblemTopic[] = [
  {
    ...
    problems: [
      ...
      p("Remove Duplicates from Sorted Array", "E", "remove-duplicates-from-sorted-array", [
      ...
      p("Find the Index of the First Occurrence in a String", "E", "find-the-index-of-the-first-occurrence-in-a-string", [
  ...
  },
  {
    ...
    problems: [
      ...
      p("Substring with Concatenation of All Words", "H", "substring-with-concatenation-of-all-words", [
  ...
  },
  {
    ...
    problems: [
      ...
      p("Intersection of Two Linked Lists", "E", "intersection-of-two-linked-lists", [
  ...
  },
  {
    name: "Stacks & Queues",
    problems: [
      p("Implement Queue using Stacks", "E", "implement-queue-using-stacks", [
  ...
  },
  {
    ...
    problems: [
      ...
      p("Flatten Binary Tree to Linked List", "M", "flatten-binary-tree-to-linked-list", [
      ...
      p("Populating Next Right Pointers in Each Node", "M", "populating-next-right-pointers-in-each-node", [
      ...
      p("Binary Search Tree Iterator", "M", "binary-search-tree-iterator", [
      ...
      p("Convert Sorted Array to Binary Search Tree", "E", "convert-sorted-array-to-binary-search-tree", [
  ...
  },
  {
    name: "Tries & Design",
    problems: [
      p("Insert Delete GetRandom O(1)", "M", "insert-delete-getrandom-o1", [
  ...
  },
  {
    ...
    problems: [
      ...
      p("Find K Pairs with Smallest Sums", "M", "find-k-pairs-with-smallest-sums", [
  ...
  },
  {
    ...
    problems: [
      ...
      p("Bitwise AND of Numbers Range", "M", "bitwise-and-of-numbers-range", [
